    ...
    public partial class MigracaoDisputas : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonagemHabilidades_PersonagemHabilidades_PersonagemHabilidadePersonagemId_PersonagemHabilidadeHabilidadeId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 35, "Arma A", 1 });

            migrationBuilder.InsertData(
                table: "Armas",
                columns: new[] { "Id", "Dano", "Nome", "PersonagemId" },
                values: new object[] { 2, 35, "Arma B", 2 });

            migrationBuilder.InsertData(
                table: "Armas",
                columns: new[] { "Id", "Dano", "Nome", "PersonagemId" },
                values: new object[] { 3, 31, "Arma C", 3 });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonagemHabilidades_PersonagemHabilidadePersonagemId_PersonagemHabilidadeHabilidadeId",
                table: "PersonagemHabilidades",
